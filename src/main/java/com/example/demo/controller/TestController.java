...
public class TestController {
    ...
    public String create() {
        ...
        User u = new User("dd", "cc123456", "dd@126.com", "dd", formattedDate);
        User u2 = userRepository.saveAndFlush(u);

        System.out.println("xx "+u2.getId());
    ...
    public String addContext(@RequestParam("id") String id, @RequestParam("context_text") String context_text) {
        Context context = new Context();
        System.out.println(id+":"+context_text);
        context.setId(id);
        context.setContext_text(context_text);

        Context context1 = contextRepository.saveAndFlush(context);
    ...
    public String addQas(@RequestParam("id") String id, @RequestParam("question") String question, @RequestParam("answer_text") String answer_text,
                      @RequestParam("answer_start") int answer_start, @RequestParam("context_id") String context_id) {
        Qas qas = new Qas();
        qas.setId(id);
